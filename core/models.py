...
class Motorbike(models.Model):
    ...
    vehicle_details = models.TextField(null=True, blank=True, verbose_name='รายละเอียดรถเพิ่มเติม')
    symptoms = models.TextField(null=True, blank=True, verbose_name='อาการรถ (default)')
    created_at = models.DateTimeField(auto_now_add=True)
...
class Booking(models.Model):
    ...
    symptoms = models.TextField(null=True, blank=True, verbose_name='อาการรถ (จองคิว)')
